...
############################################################################################
scoreboard players reset @s[scores={shovel_grass_blc=1..}] shovel_grass_blc
...
scoreboard players reset @s[scores={shovel_red_sand=1..}] shovel_red_sand
scoreboard players reset @s[scores={shovel_soul_sand=1..}] shovel_soul_sand