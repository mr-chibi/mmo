...
scoreboard objectives remove qs_harvest_crops
scoreboard objectives remove qs_mine_ore
scoreboard objectives remove qs_plant_crops
scoreboard objectives remove qs_slay_mob
scoreboard objectives remove qs_slay_boss
scoreboard objectives remove qs_level_up
scoreboard objectives remove qs_ran