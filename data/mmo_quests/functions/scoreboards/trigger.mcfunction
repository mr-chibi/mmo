...
execute as @s[scores={quest_info=1}] run execute as @e[type=minecraft:villager,tag=mmo_quests] at @s unless entity @p[distance=0..5,scores={qs_level_up=0}] run scoreboard players add @p qs_level_up 0
