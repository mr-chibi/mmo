...
data modify entity @s CustomName set value "{\"text\": \"Skeleton Archer Lvl 4\"}"
data modify entity @s HandItems set value [{id:"minecraft:bow", Count:1b,tag:{Enchantments:[{id:"minecraft:power", lvl:1}]}}, {id:"minecraft:shield", Count:1b}]
