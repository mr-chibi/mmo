...
# Mob Attack Strength:
attribute @s minecraft:generic.attack_damage base set 10.5

# Mob Defense:
attribute @s minecraft:generic.armor base set 17
attribute @s minecraft:generic.armor_toughness base set 17

# Mob CustomName:
data modify entity @s CustomNameVisible set value 1b
data modify entity @s CustomName set value "{\"text\": \"Skeleton [Lvl 25]\", \"color\": \"white\"}"
