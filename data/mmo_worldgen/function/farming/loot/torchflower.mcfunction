...
execute as @e[type=minecraft:armor_stand,tag=block_rng,tag=1,tag=selected,team=rng_blue,sort=nearest] at @s run give @p minecraft:torchflower 2
...
execute as @e[type=minecraft:armor_stand,tag=block_rng,tag=19,tag=selected,team=rng_blue,sort=nearest] at @s run give @p minecraft:torchflower 3