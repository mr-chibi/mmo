...
############################################################################################
execute store result score @s[scores={cut_stripped_pale_oak_log=1..}] wc_vein_count positioned ~ ~ ~1 store result score @s wc_vein_count if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:stripped_pale_oak_log"}},sort=nearest,distance=0..10]
execute store result score @s[scores={cut_stripped_pale_oak_log=1..}] wc_vein_count positioned ~ ~ ~-1 store result score @s wc_vein_count if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:stripped_pale_oak_log"}},sort=nearest,distance=0..10]
execute store result score @s[scores={cut_stripped_pale_oak_log=1..}] wc_vein_count positioned ~ ~1 ~ store result score @s wc_vein_count if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:stripped_pale_oak_log"}},sort=nearest,distance=0..10]
execute store result score @s[scores={cut_stripped_pale_oak_log=1..}] wc_vein_count positioned ~ ~-1 ~ store result score @s wc_vein_count if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:stripped_pale_oak_log"}},sort=nearest,distance=0..10]
execute store result score @s[scores={cut_stripped_pale_oak_log=1..}] wc_vein_count positioned ~1 ~ ~ store result score @s wc_vein_count if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:stripped_pale_oak_log"}},sort=nearest,distance=0..10]
...
execute if score @s[scores={wc_vein_count=5..}] cut_stripped_pale_oak_log matches 1.. run scoreboard players operation @s wc_vein_count *= cut_stripped_pale_oak_log stats_experience