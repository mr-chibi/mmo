############################################################################################
	# Durability #
############################################################################################
execute if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:amethyst_shard"}}] unless data entity @s Item.components.minecraft:enchantments.minecraft:unbreaking run data modify entity @s Item.components.minecraft:enchantments.minecraft:unbreaking set value 1
