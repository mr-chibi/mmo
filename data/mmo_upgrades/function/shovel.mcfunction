...
############################################################################################
	# Modify Tool Data: #
############################################################################################
execute if entity @e[type=minecraft:item,nbt={Item:{id:"minecraft:redstone"}}] unless data entity @s Item.components.minecraft:tool.rules[0].speed run data modify entity @s Item.components.minecraft:tool.rules insert 0 from storage minecraft:mmo_tools items.shovel
...
############################################################################################
	# Update Tool [Desc]: #
############################################################################################
execute if score @s test matches 1.. run function mmo_upgrades:lore/shovel_speed with entity @s Item.components.minecraft:tool.rules[0]
