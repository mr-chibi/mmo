...
execute if score mmo mmo_addons matches 1 if score mmo_mobs mmo_addons matches 2 run tellraw @a [{"text": "[", "color": "white"},{"text": "Mr_Chibi'sMMO Mobs", "color":"red"}, {"text": "] ", "color": "white"}]
