...
execute if items entity @s weapon.mainhand minecraft:book[minecraft:custom_data={Tags:["mmo_magic","fire_spell"]}] run tag @s add holding_fire_spell
...
execute if items entity @s weapon.mainhand minecraft:book[minecraft:custom_data={Tags:["mmo_magic","nature_spell"]}] run tag @s add holding_nature_spell
...
execute unless items entity @s weapon.mainhand minecraft:book[minecraft:custom_data={Tags:["mmo_magic","fire_spell"]}] run tag @s remove holding_fire_spell
...
execute unless items entity @s weapon.mainhand minecraft:book[minecraft:custom_data={Tags:["mmo_magic","nature_spell"]}] run tag @s remove holding_nature_spell
