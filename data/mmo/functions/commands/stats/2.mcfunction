...
tellraw @s [{"text":"[1]", "color":"white", "bold":false, "clickEvent":{"action":"run_command","value":"/trigger mmo_stats set 1"}}, {"text": " | ", "color": "white", "bold":false}, {"text":"[2]", "color":"yellow", "bold":true}, {"text": " | ", "color": "white", "bold":false}, {"text":"[3]", "color":"white", "bold":false, "clickEvent":{"action":"run_command","value":"/trigger mmo_stats set 3"}}]
