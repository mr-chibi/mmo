#
scoreboard objectives remove farming_lvl
scoreboard objectives remove farming_exp
scoreboard objectives remove farming_lvlup
...
scoreboard objectives remove plant_berries
scoreboard objectives remove plant_pumpkin
scoreboard objectives remove plant_melon
...
scoreboard objectives remove harvest_carrot
scoreboard objectives remove harvest_potatoe
scoreboard objectives remove harvest_berries
scoreboard objectives remove harvest_pumpkin
